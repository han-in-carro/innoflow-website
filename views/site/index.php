...
<div
        id="page-container"
        class="mx-auto flex min-h-dvh w-full min-w-80 flex-col overflow-hidden bg-gray-100 dark:bg-gray-900 dark:text-gray-100"
>
    <!-- Page Content -->
            ...
            >
                ...
                <div class="grid grid-cols-2 gap-2 text-center lg:grid-cols-6">
                    <div class="flex items-center justify-center">
                        ...
                        >
                            <svg
                                    class="hi-solid hi-cube inline-block size-6 text-indigo-600 dark:text-indigo-500"
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    fill="currentColor"
                                    aria-hidden="true"
                    ...
                    <div class="flex items-center justify-center">
                        ...
                        >
                            <svg
                                    class="hi-solid hi-code-bracket-square inline-block size-6 text-purple-600 dark:text-purple-500"
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    fill="currentColor"
                                    aria-hidden="true"
                    ...
                    <div class="flex items-center justify-center">
                        ...
                        >
                            <svg
                                    class="hi-solid hi-cursor-arrow-rays inline-block size-6 text-rose-600 dark:text-rose-500"
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    fill="currentColor"
                                    aria-hidden="true"
                    ...
                    <div class="flex items-center justify-center">
                        ...
                        >
                            <svg
                                    class="hi-mini hi-variable inline-block size-6 text-pink-600 dark:text-pink-500"
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 20 20"
                                    fill="currentColor"
                                    aria-hidden="true"
                    ...
                    <div class="flex items-center justify-center">
                        ...
                        >
                            <svg
                                    class="hi-solid hi-map-pin inline-block size-6 text-teal-600 dark:text-teal-500"
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24"
                                    fill="currentColor"
                                    aria-hidden="true"
                ...
                >
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-8 lg:grid-cols-3">
                        <div class="flex items-center gap-3">
                            ...
                            <h3 class="font-semibold line-through">Work is scattered across spreadsheets, chat tools,
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <h3 class="font-semibold line-through">Processes live in people’s heads instead of being
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <h3 class="font-semibold line-through">Status changes without clear ownership or
                                accountability</h3>
                        </div>
                        <div class="flex items-center gap-3">
                            <div
                            ...
                            <h3 class="font-semibold line-through">Rigid tools force teams into workflows that don’t fit
                                their real needs</h3>
                        </div>
                        <div class="flex items-center gap-3">
                            <div
                            ...
                            <h3 class="font-semibold line-through">Follow-ups and approvals rely on manual reminders
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <h3 class="font-semibold line-through">Teams lack a clear, real-time view of progress,
            ...
            >
                ...
                <div class="grid grid-cols-1 gap-12 md:grid-cols-3 md:gap-6 lg:gap-10">
                    <div class="space-y-6">
                        ...
                        <nav class="flex flex-col items-start gap-3 text-sm">
                            <a
                                    href="javascript:void(0)"
                        ...
                        >
                            <div class="flex items-center">
                                <input
                                        ...
                                        class="block w-full grow rounded-l-lg border border-gray-200 px-3 py-2 text-sm leading-5 placeholder-gray-500 focus:z-1 focus:border-gray-500 focus:ring-3 focus:ring-gray-500/50 dark:border-gray-700/75 dark:bg-gray-950 dark:placeholder-gray-400 dark:focus:border-gray-500"
                                />
                                <button
                                        type="submit"
                                        class="-ml-px inline-flex flex-none items-center justify-center gap-2 rounded-r-lg border border-gray-700 bg-gray-700 px-3 py-2 text-sm leading-5 font-semibold text-white hover:border-gray-600 hover:bg-gray-600 hover:text-white focus:ring-3 focus:ring-gray-400/50 active:border-gray-700 active:bg-gray-700 dark:focus:ring-gray-400/90"
                                >
                                    Subscribe
                                </button>
                            </div>
                ...
                <hr
                        class="my-10 border-dashed border-gray-200 dark:border-gray-700/75"
                />
                <div
